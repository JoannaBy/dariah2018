...
* Teksty przykładowe z Polony -> ciekawe problemy
* 10 próbek różnej długości i różnego pochodzenia ()
* 
...
* Fajnie, że bilioteki robią skany
* ale nawet do atrybucji są niedostateczne
* Teksty z XIX trzeba po prostu przepisać (łatwe do przepisania)
* za granicą TTR już prawie tak dobry jak OCR


a = c(6.5, 82.5, 38.4, 13.6, 7, 5.35, 11.7, 6.8, 4.5, 43)
plot(sort(a), ylim=c(0,100), type="h", lwd=10)
